...
class Edd_Single_Product extends Base {
	...
	public function get_title() {
		return __( 'EDD Single Product', 'happy-addons-pro' );
	}
	...
	public function get_keywords() {
		return ['edd', 'single-product', 'single', 'product', 'woocommerce', 'single-shop', 'shop', 'ha-skin'];
	}
	...
	protected function featured_image_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'toggle'         => false,
				'default'        => 'left',
				'prefix_class'   => 'ha-edd-single-product__img_pos-',
				'style_transfer' => true,
				'condition'      => [
					'skin' => 'landscape',
				],
	...
	protected function settings_content_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'            => [
					'{{WRAPPER}} .ha-edd-single-product__content' => '{{VALUE}}',
				],
				'condition'            => [
					'skin' => 'landscape',
				],
	...
	protected function box_style_tab_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__item ' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'item_border',
				'selector' => '{{WRAPPER}} .ha-edd-single-product__item ',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__item ' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function badge_discount_style_controls_section() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__badge span:nth-of-type(2)' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
				'conditions' => [
					'relation' => 'and',
					'terms'    => [
	...
	protected function badge__offset() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__badge' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__badge' => 'top: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function badge_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__badge-text' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'badge_text!' => '',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__badge-text' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'badge_text!' => '',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__badge-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'badge_text!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} span.ha-edd-single-product__badge-text' => 'color: {{VALUE}};',
				],
				'condition' => [
					'badge_text!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} span.ha-edd-single-product__badge-text' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'badge_text!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				'name'      => 'badge_border',
				'selector'  => '{{WRAPPER}} span.ha-edd-single-product__badge-text',
				'condition' => [
					'badge_text!' => '',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__badge-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'badge_text!' => '',
				],
	...
	protected function discount_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__discount-text' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'discount_text!' => '',
					'skin'           => 'classic',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__discount-text' => 'height: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'discount_text!' => '',
					'skin'           => 'classic',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__discount-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'discount_text!' => '',
					'skin'           => 'classic',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} span.ha-edd-single-product__discount-text' => 'color: {{VALUE}};',
				],
				'condition' => [
					'discount_text!' => '',
					'skin'           => 'classic',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} span.ha-edd-single-product__discount-text' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'discount_text!' => '',
					'skin'           => 'classic',
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} span.ha-edd-single-product__discount-text',
				'condition' => [
					'discount_text!' => '',
					'skin'           => 'classic',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} span.ha-edd-single-product__discount-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'discount_text!' => '',
					'skin'           => 'classic',
	...
	protected function image_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__img' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'skin!' => 'landscape',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__img img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__img img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__img img' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'img_border',
				'selector' => '{{WRAPPER}} .ha-edd-single-product__img img',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__img img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__item :hover .ha-edd-single-product__img img' => 'opacity: {{SIZE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ha-edd-single-product__item :hover .ha-edd-single-product__img img',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__img img' => 'transition-duration: {{SIZE}}s;',
				],
			]
		);
	...
	protected function content_style_controls_section() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function rating_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__ratings' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'show_rating' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__ratings' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'show_rating' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__ratings .star-rating' => 'color: {{VALUE}}',
				],
				'condition' => [
					'show_rating' => 'yes',
				],
	...
	protected function cat_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__category' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'show_cat' => 'yes',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__category a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'show_cat' => 'yes',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .ha-edd-single-product__category a',
				'condition' => [
					'show_cat' => 'yes',
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__category a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'show_cat' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__category a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__category a' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__category a:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ha-edd-single-product__category a:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__category a:hover' => 'border-color: {{VALUE}}',
				],
			]
		);
	...
	protected function title_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__title' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => __( 'Typography', 'happy-addons-pro' ),
				'selector' => '{{WRAPPER}} .ha-edd-single-product__title',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__title a' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__title:hover a' => 'color: {{VALUE}}',
				],
			]
		);
	}
	...
	protected function excerpt_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__desc' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'excerpt_length!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__desc' => 'color: {{VALUE}}',
				],
				'condition' => [
					'excerpt_length!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Typography', 'happy-addons-pro' ),
				'selector'  => '{{WRAPPER}} .ha-edd-single-product__desc',
				'scheme'    => Typography::TYPOGRAPHY_3,
				'condition' => [
					'excerpt_length!' => '',
				],
	...
	protected function price_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'em'],
				'selectors'  => [
					'{{WRAPPER}} .ha-edd-single-product__price' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'show_price' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ha-edd-single-product__price' => 'color: {{VALUE}}',
				],
				'condition' => [
					'show_price' => 'yes',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => __( 'Typography', 'happy-addons-pro' ),
				'selector'  => '{{WRAPPER}} .ha-edd-single-product__price',
				'scheme'    => Typography::TYPOGRAPHY_3,
				'condition' => [
					'show_price' => 'yes',
				],
	...
	protected function cart_and_qv_button_style_controls_section() {
		...
		$this->add_control(
			...
			[
				...
				'prefix_class' => 'ha-edd-single-product__qv_pos-',
				'condition'    => [
					'skin' => 'classic',
				],
			]
	...
	protected function cart_button_style_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'show_cart_button' => 'yes',
				],
		...
		$this->add_group_control(
			...
			[
				...
				{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart, 
				{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition'  => [
					'show_cart_button' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart, {{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart, {{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue' => 'background: {{VALUE}};',
				],
				'condition' => [
					'show_cart_button' => 'yes',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .button, {{WRAPPER}} .added_to_cart, {{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart, {{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue',
				'condition' => [
					'show_cart_button' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart:hover, {{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue:hover' => 'color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart:hover, {{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue:hover' => 'background: {{VALUE}};',
				],
				'condition' => [
					'show_cart_button' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart:hover, {{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue:hover' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'show_cart_button'        => 'yes',
		...
		$this->add_group_control(
			...
			[
				...
				{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-add-to-cart:hover,
				{{WRAPPER}} .ha-edd-single-product__atc-btn .edd-submit.button.blue:hover',
				'condition' => [
					'show_cart_button' => 'yes',
				],
			]
	...
	protected function get_feature_image( $settings ) {
		?>
			<a href="<?php the_permalink(); ?>" rel="bookmark" class="ha-edd-single-product__feature_img">
				<?php
	...
	protected function print_quick_view_button( $product_id ) {
		...
		printf(
			'<a href="#" data-mfp-src="%s" class="ha-pqv-btn" title="%s" data-modal-class="ha-pqv-edd--%s"><i class="fas fa-expand-alt"></i></a>',
			esc_url( $url ),
				...
				<div class="ha-edd-single-product__badge">
					...
					if ( $badge_text ) {
						printf( '<span %1$s>%2$s</span>',
							'class="ha-edd-single-product__badge-text"',
							esc_html( $badge_text )
						);
					}
					if ( $discount_text ) {
						printf( '<span %1$s>%2$s</span>',
							'class="ha-edd-single-product__discount-text"',
			...
			<?php if ( $show_cart_button === 'yes' || $show_quick_view_button === 'yes' ) : ?>
				<div class="ha-edd-single-product__btns">
					...
					if ( $show_cart_button === 'yes' ) {
						$this->ha_edd_ajax_add_to_cart_link( $product );
					}
	...
	public function render() {
		...
		$this->add_render_attribute(
			...
			'class',
			[
				'ha-edd-single-product__item ',
				'ha-edd-single-product__' . $settings['skin'],
			]
		);
				...
				<div class="ha-edd-single-product__content">
					...
					<?php if ( $settings['show_cat'] === 'yes' ) : ?>
						<div class="ha-edd-single-product__category">
							<?php echo ha_pro_the_first_taxonomy( $post->ID, 'download_category', ['class' => 'ha-edd-single-product__category_inner'] ); ?>
						</div>
					<?php endif; ?>

					<<?php echo ha_escape_tags( $settings['title_tag'], 'h2' ) . ' class="ha-edd-single-product__title"'; ?>>
						<a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a>
					</<?php echo ha_escape_tags( $settings['title_tag'], 'h2' ); ?>>

					<?php if ( ! empty( $settings['excerpt_length'] ) ) : ?>
						<p class="ha-edd-single-product__desc">
						...
						<?php if ( $settings['show_cart_button'] === 'yes' ) : ?>
							<div class="ha-edd-single-product__atc-btn">
								...
								if ( edd_has_variable_prices( $post->ID ) ) {
									...
									echo edd_get_purchase_link( [ 'download_id' => $post->ID, 'text' => $settings['add_to_cart_text'] ] );
